...
import Johnston_Functions as MY
import numpy as np
...
print 'Random 1000-element array #1: '
random_repeated_1 = COUNTER(random_1)
print '\n \n Random 1000-element array #2: '
random_repeated_2 = COUNTER(random_2)
print '\n \n Random 1000-element array #3: '
random_repeated_3 = COUNTER(random_3)

print '\n \n JvN 1000-element array #1: '
JvN_repeated_1 = COUNTER(Random_JvN_1_seedarray)
print '\n \n JvN 1000-element array #2: '
JvN_repeated_2 = COUNTER(Random_JvN_2_seedarray)
print '\n \n JvN 1000-element array #3: '
JvN_repeated_3 = COUNTER(Random_JvN_3_seedarray)
print 'END PROJECT 1 -- PART B-iii-b-i\n\n\n\n'


#B-iii-b-ii:
print '\n\nBEGIN PROJECT 1 -- PART B-iii-b-ii\n\n'
MY.CHI2(random_repeated_1.total, 100, 9, 0, 'Random repeated number in bins array comparison #1')
MY.CHI2(random_repeated_2.total, 100, 9, 0, 'Random repeated number in bins array comparison #2')
MY.CHI2(random_repeated_3.total, 100, 9, 0, 'Random repeated number in bins array comparison #3')
